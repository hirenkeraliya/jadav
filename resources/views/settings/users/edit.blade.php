...
@section('breadcrumb')
  <a href="{{ route('settings.users') }}" style="color:#8b5cf6;text-decoration:none">Settings / Users</a> / Edit User
@endsection
...
<div style="display:flex;gap:20px;max-width:1100px">
  ...
  <div style="flex:1">
    <h1 class="page-title" style="margin-bottom:24px">Edit User</h1>

    <div class="card" style="margin-bottom:20px">
      <div class="card-header"><span style="font-weight:700">User Details</span></div>
      <div class="card-body">
          ...
          <div style="margin-bottom:20px">
            ...
            <div style="display:flex;flex-wrap:wrap;gap:10px">
              ...
              <label style="display:flex;align-items:center;gap:6px;font-size:0.875rem;cursor:pointer">
                <input type="checkbox" name="companies[]" value="{{ $co->id }}" {{ in_array($co->id, old('companies', $userCompanies)) ? 'checked' : '' }}>
                {{ $co->name }}
              </label>
              @endforeach
            </div>
    ...
    {{-- Reset Password --}}
    <div class="card">
      <div class="card-header"><span style="font-weight:700">Reset Password</span></div>
      <div class="card-body">
