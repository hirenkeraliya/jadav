<header class="topbar">
  ...
  <div class="flex items-center gap-3">
    ...
    <a href="{{ route('company.select') }}"
       style="display:flex;align-items:center;gap:6px;padding:6px 12px;background:var(--color-primary-subtle);border-radius:8px;font-size:0.8rem;font-weight:600;color:var(--color-primary-text-dark);text-decoration:none">
    ...
    <div style="position:relative" x-data="{ open: false }">
      <button @click="open = !open"
        ...
        @else
          <div style="width:24px;height:24px;border-radius:50%;background:linear-gradient(135deg,var(--color-primary),var(--color-primary-light));display:flex;align-items:center;justify-content:center;color:#fff;font-size:0.65rem;font-weight:800">
      ...
      <div x-show="open" @click.away="open = false"
           style="position:absolute;right:0;top:100%;margin-top:6px;background:#fff;border:1px solid var(--color-primary-border);border-radius:12px;box-shadow:0 10px 40px color-mix(in srgb,var(--color-primary) 15%,transparent);min-width:180px;z-index:100;overflow:hidden">
